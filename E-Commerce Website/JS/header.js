   ...
   header.innerHTML = `<div class="row">                                                                                   <!--Header Creation-->
   <div class="col-lg-3">
     <h1>Hemanthh</h1>                                                                                                          <!--Logo-->
   </div>
   ...
   <div class="col-lg-7">                                                                                                <!--Search box and button -->
       <input 
           ...
           style="height: 30px; width: 70%; margin-top: 12px; border-bottom-left-radius: 10px; padding-bottom: 3px; outline: none;">  

       <button 
           type="button" 
           class="btn btn-primary" 
           style="height: 30px; margin-top: -4px; padding-top: 2px; margin-left: -5px; border-radius: 0px 10px 0px 0px; background-color: #008080; font-weight: bold;">
           Search
       </button>
   </div>
